...
> عبارات منظم یک گروه از کارکترها یا نمادهاست که برای پیدا کردن یک الگوی مشخص در یک متن به کار گرفته می‌شود.
</div>

<div dir="rtl">
یک عبارت منظم یک الگو است که با رشته‌ای خاص مطابقت دارد. عبارت منظم در اعتبار سنجی داده‌های ورودی فرم‌ها، پیدا کردن یک زیر متن در یک متن بزرگ‌تر بر اساس یک الگوی ویژه و مواردی از این دست به کار گرفته می‌شود. عبارت "Regular expression" کمی طولانی‌ست، پس معمولاً بیشتر مخفف آن یعنی "regex" یا "regexp" را به کار می‌برند.

فرض کنید که برنامه‌ای نوشته‌اید و می‌خواهید قوانینی برای گزینش نام کاربری برای کاربران بگذارید؛ می‌خواهیم اجازه دهیم که نام کاربری شامل حروف، اعداد، خط زیر و خط فاصله باشد. همچنین می‌خواهیم تعداد کارکترها را در نام کاربری محدود کنیم. ما از چنین عبارت منظمی برای اعتبار سنجی نام کاربری استفاده می‌کنیم:
</div>
<br/><br/>
<p align="center">
